                ...
                <div className="container" style={{ padding: "var(--space-20) 0", maxWidth: "800px", margin: "0 auto" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-6)", color: "var(--color-gray-700)", lineHeight: "1.8" }}>
                        ...
                        <section>
                            ...
                            <p>Recopilamos información personal que usted nos proporciona voluntariamente al registrarse en nuestro sitio web o contactarnos directamente. La información personal recopilada puede incluir nombre, dirección de correo electrónico, número de teléfono y nombre de la empresa.</p>
                        </section>

                        <section>
                            <h2 style={{ fontSize: "var(--text-2xl)", color: "var(--color-dark)", marginBottom: "var(--space-3)" }}>2. Uso de la información</h2>
                            <p>Utilizamos la información recopilada para: proveer y mantener nuestros servicios de consultoría, notificarle sobre cambios en nuestros servicios, brindarle soporte y analizar cómo se utiliza nuestro sitio web para mejorarlo.</p>
                        </section>

                        <section>
                            <h2 style={{ fontSize: "var(--text-2xl)", color: "var(--color-dark)", marginBottom: "var(--space-3)" }}>3. Protección de datos</h2>
                            <p>Implementamos medidas de seguridad para mantener la seguridad de su información personal. No vendemos, intercambiamos ni transferimos a terceros su información personal identificable. Esto no incluye a terceros de confianza que nos asisten en la operación de nuestro sitio web o en la conducción de nuestro negocio (como nuestro proveedor de correo para respuestas de contacto o base de datos estructurada en Supabase), siempre que dichas partes acuerden mantener esta información confidencial.</p>
                        </section>
